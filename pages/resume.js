            ...
            <ul>
              <li className="mb-8 flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm mb-1">Technology Consultant - Product Management</p>
                </div>
              </li>
              <li className="mb-8 flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm mb-1">Technology and Research Consultant</p>
                </div>
              </li>
              <li className="mb-8 flex items-center">
